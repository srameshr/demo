...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__feed_service__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__updates_update_component__ = __webpack_require__(32);
...
var Feed = function () {
    function Feed() {
        ...
        this.updates = new __WEBPACK_IMPORTED_MODULE_1__updates_update_component__["a" /* default */]();
    }

    _createClass(Feed, [{
        key: 'getFeed',
        value: async function getFeed() {
            try {
                var data = await Object(__WEBPACK_IMPORTED_MODULE_0__feed_service__["a" /* getFeed */])();
                return data;
            } catch (e) {
                throw Error(e);
            }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getFeed; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_data_service__ = __webpack_require__(33);


var getFeed = function getFeed() {
    return Object(__WEBPACK_IMPORTED_MODULE_0__core_data_service__["a" /* get */])({ url: '/data/feed.json' });
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__template__ = __webpack_require__(34);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Updates = function () {
    ...
    _createClass(Updates, [{
        key: 'getUpdates',
        value: function getUpdates(_ref) {
            var _this = this;

            var feeds = _ref.feeds;

            return feeds.map(function (feed) {
                return _this.hydrateFeed(feed);
            });
        }
    }, {
        key: 'hydrateFeed',
        value: function hydrateFeed(feed) {
            return Object(__WEBPACK_IMPORTED_MODULE_0__template__["a" /* constructTemplate */])(feed);
        }
    }]);
...
/* harmony default export */ __webpack_exports__["a"] = (Updates);
...
var Header = function (_HeaderCtrl) {
  _inherits(Header, _HeaderCtrl);

  function Header() {
    _classCallCheck(this, Header);

    // Will cache side menu toggling DOM elements
  ...
  _createClass(Header, [{
    key: 'contructHeader',
    value: function contructHeader() {
      $("#header").append(__WEBPACK_IMPORTED_MODULE_1__header_templates__["a" /* template */]);
    }
  }, {
    key: 'listenForToggleEvents',
    value: function listenForToggleEvents() {
      var $togglerIcon = $(".toggler-icon");
  ...
  return Header;
}(__WEBPACK_IMPORTED_MODULE_0__header_controller__["a" /* default */]);
...
/* harmony default export */ __webpack_exports__["a"] = (HeaderCtrl);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__status_template__ = __webpack_require__(39);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
